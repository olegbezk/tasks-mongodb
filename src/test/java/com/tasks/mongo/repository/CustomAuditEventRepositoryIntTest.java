package com.tasks.mongo.repository;

import com.tasks.mongo.TasksAppMongoApp;
import com.tasks.mongo.config.Constants;
import com.tasks.mongo.config.audit.AuditEventConverter;
import com.tasks.mongo.domain.PersistentAuditEvent;
...
import static com.tasks.mongo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
